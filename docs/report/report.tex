...
concept HasAdjunctionShape =
    ...
    std::same_as<typename F::Sigma_cat, typename U::Tau_cat> &&
    std::same_as<typename F::Tau_cat,   typename U::Sigma_cat>;

// 4-param witness form: unit and counit are natural transformations.
export template <typename F, typename U, typename Eta, typename Epsilon>
concept IsAdjunction =
    HasAdjunctionShape<F, U> &&
    IsUnitOfAdjunction<Eta, F, U> &&         // Id_D ==> U o F
    IsCounitOfAdjunction<Epsilon, F, U>;     // F o U ==> Id_C
