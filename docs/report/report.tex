...
\midrule
A1--A6 & Partial / implementation-backed by partition-level surfaces & \#195, \#152, \#167 \\
A7 (NNO / power-object-adjacent proof surface) & Deferred-to-partial transition in progress & \#195, \#152, \#167 \\
A10 (choice semantics) & Deferred (explicitly scoped, not implied complete) & \#195 \\
\bottomrule
\end{tabular}
\end{table}
...
\midrule
A1--A3 (composition/identity/products) & Partial & \#195, \#152 \\
A4--A5 (equalizers/classifier-adjacent structure) & Partial & \#195, \#152, \#167 \\
A6 (exponential/cartesian-closed surface) & Partial & \#195, \#167 \\
A7 (NNO/proof-surface maturation) & Deferred $\rightarrow$ Partial (in progress) & \#195, \#152, \#267 \\
A10 (choice/well-pointed semantics posture) & Deferred & \#195, \#267 \\
\bottomrule
\end{tabular}
\end{table}
