...
A7 (subobject classifier / pullback / naturality surface) & Partial (witness shape + law-surface checks; full naturality closure pending) & \#195, \#351 \\
A10 (choice semantics) & Partial (split-epi witness shape + law-surface checks; full choice deferred) & \#195, \#352 \\
\bottomrule
\end{tabular}
\end{table}
...
A7 (classifier stability and naturality closure) & Partial (reindexing law surface added) & \#195, \#351 \\
A10 (choice / split-epi semantics) & Partial (shape + law surface implemented) & \#195, \#352 \\
\bottomrule
\end{tabular}
\end{table}
...
\begin{itemize}
  ...
  \texttt{HasAxiom7PullbackReindexingLawSurface} (reindexing law via \texttt{classifier\_reindexing\_law\_at}).
...
7 & Subobject classifier ($\chi: A \to \Omega$) & \texttt{HasAxiom7SubobjectClassifier}, optional \texttt{HasAxiom7ClassifierNaturalityWitness} and \texttt{HasAxiom7PullbackReindexingLawSurface} & classifier predicates (\texttt{bool}/\texttt{Ternary}), \texttt{classifier\_true/false}, \texttt{classifier\_reindexing\_law\_at} \\
