...
Membership is the two conditions together: the type is a set (the Tarski layer $\mathbf{Trsk}$ of §\ref{sec:intensional_sets}), and its carrier passes the algebra gate \cppinline{IsAlgebraOnSet} of Listing~\ref{lst:algebra:universal}, which asks that the carrier be closed under the operations it supplies:
\begin{equation}
