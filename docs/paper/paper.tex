...
\begin{lstlisting}[caption={language=C++, Illustration of the symbolic construction of $e$ as an intensional set (the lower cut $L \subset \mathbb{Q}$).}, label={lst:euler}]
