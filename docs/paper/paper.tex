...
% ============================================================
\subsection{An Elementary Theory of the Category of Sets}
\label{sec:ddk_etcs}
% ============================================================
...
Implementations such as \cppinline{std::set} use this as a starting point and proceed to model sets as \emph{extensional} memory containers where the membership test is carried out by checking if a given value can be found in the container. 
