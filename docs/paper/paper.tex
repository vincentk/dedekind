...
The type system selects between a signed-unimodular bit-ops kernel and a generic implementation of Cramer's rule based on structural properties of the input Set's predicate; the output Set's predicate type encodes the mathematical regime (singleton, empty, or unbounded face).
