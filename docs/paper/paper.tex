...
\begin{table}[htbp]
\centering
\caption{The three Birkhoff constructions H, S, P read across vocabularies.  Each column builds a new carrier from a given one and propagates its certificate; the \emph{finitary} row marks that only finite products are type-level constructible.}
...
category theory      & coequalizer (regular epi)               & subobject (mono)                & product (limit) \\
