...
A concrete type that type checks against \cppinline{concept IsSet} should support all of the above functionality and allow the evaluation of non-trivial set comprehensions.
\begin{equation}
  \emptyset = \{x \in \mathbb N \mid \}. \cap \emptyset
\end{equation}
Such an implementation will be presented in the next Section~\ref{sec:ddk_comprehension}.
