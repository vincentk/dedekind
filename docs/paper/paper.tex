...
% Custom column type for uniform data cells
\newcolumntype{Y}{>{\centering\arraybackslash}p{0.82cm}}
...
\small
\begin{tabular}{l|cc|ccc|ccc|ccc|ccc|ccc|cc}
\toprule
\textbf{Species} & \multicolumn{2}{c|}{\textbf{bool}} & \multicolumn{3}{c|}{\textbf{bool (Bit)}} & \multicolumn{3}{c|}{\textbf{uint}} & \multicolumn{3}{c|}{\textbf{uint (O/B)}} & \multicolumn{3}{c|}{\textbf{int}} & \multicolumn{3}{c|}{\textbf{int (Bit)}} & \multicolumn{2}{c}{\textbf{double}} \\ \midrule
\textbf{Category} & \multicolumn{2}{c|}{Logical} & \multicolumn{3}{c|}{Bitwise} & \multicolumn{3}{c|}{Arith.} & \multicolumn{3}{c|}{Order/Bit} & \multicolumn{3}{c|}{Arith.} & \multicolumn{3}{c|}{Bitwise} & \multicolumn{2}{c}{Arith.} \\ \midrule
\textbf{Operator} & \texttt{||} & \texttt{\&\&} & \texttt{|} & \texttt{\&} & \texttt{\^{}} & \texttt{+} & \texttt{*} & \texttt{\%} & \texttt{min} & \texttt{max} & \texttt{\^{}} & \texttt{+} & \texttt{*} & \texttt{\%} & \texttt{|} & \texttt{\&} & \texttt{\^{}} & \texttt{+} & \texttt{*} \\ \midrule

\textbf{Identity}   & \texttt{f} & \texttt{t} & \texttt{f} & \texttt{t} & \texttt{f} & \texttt{0} & \texttt{1} & --- & \texttt{max} & \texttt{0} & \texttt{0} & \texttt{0} & \texttt{1} & --- & \texttt{0} & \texttt{-1} & \texttt{0} & \texttt{0.0} & \texttt{1.0} \\ 
\textbf{Absorber}   & \texttt{t} & \texttt{f} & \texttt{t} & \texttt{f} & --- & --- & \texttt{0} & \textbf{Hz}\textsuperscript{D} & \texttt{0} & \texttt{max} & --- & --- & \texttt{0} & \textbf{Hz}\textsuperscript{D} & \texttt{-1} & \texttt{0} & --- & \texttt{Inf} & \texttt{NaN} \\ 
\textbf{Associative}& \checkmark & \checkmark & \checkmark & \checkmark & \checkmark & \checkmark\textsuperscript{M} & \checkmark\textsuperscript{M} & --- & \checkmark & \checkmark & \checkmark & \textbf{Hz}\textsuperscript{U} & \checkmark & --- & \checkmark & \checkmark & \checkmark & \textasteriskcentered & \textasteriskcentered \\ 
\textbf{Commutative}& \checkmark & \checkmark & \checkmark & \checkmark & \checkmark & \checkmark & \checkmark & --- & \checkmark & \checkmark & \checkmark & \checkmark & \checkmark & --- & \checkmark & \checkmark & \checkmark & \checkmark & \checkmark \\ 
\textbf{Idempotent} & \checkmark & \checkmark & \checkmark & \checkmark & --- & --- & --- & --- & \checkmark & \checkmark & --- & --- & --- & --- & \checkmark & \checkmark & --- & --- & --- \\ 
\textbf{Inverse}    & --- & --- & --- & --- & \checkmark & \checkmark\textsuperscript{M} & --- & --- & --- & --- & \checkmark & \textbf{Hz}\textsuperscript{A} & --- & --- & --- & --- & \checkmark & \checkmark & \checkmark \\ 
\textbf{Monotonic}  & \checkmark & \checkmark & \checkmark & \checkmark & --- & \textbf{Hz}\textsuperscript{W} & \textbf{Hz}\textsuperscript{W} & --- & \checkmark & \checkmark & --- & \checkmark\textsuperscript{P} & \checkmark\textsuperscript{P} & --- & --- & --- & --- & \checkmark & \checkmark \\ \midrule
\textbf{Logic ($\Omega$)} & \multicolumn{5}{c|}{Classical ($\Omega_{\mathbb{B}}$)} & \multicolumn{6}{c|}{Classical ($\Omega_{\mathbb{B}}$)} & \multicolumn{6}{c|}{Classical ($\Omega_{\mathbb{B}}$)} & \multicolumn{2}{c}{Ternary ($\Omega_{K3}$)} \\ \bottomrule
\end{tabular}
