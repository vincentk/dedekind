...
This section records, per carrier, which algebraic laws the type system certifies, and at which tier of §\ref{par:concept-tiers}; recall (Figure~\ref{fig:hub-spoke-bnz}) that a carrier is the underlying set beneath an algebraic structure.
