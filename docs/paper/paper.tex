...
The open disk shows this concretely: a point inside tests yes, a point outside tests no, and a point exactly on the rim $\lVert x - c \rVert = r$ is the undecided case, since over the reals no finite-precision comparison settles $<$ against $=$.
