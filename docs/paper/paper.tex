...
Morally, a set here is just its membership test.
...
for example, they cannot natively model infinite sets, such as the natural numbers $\mathbb{N}$, or continuous intervals over $\mathbb{R}$, nor can they faithfully model sets where membership may not be computable in practice such as the Mandelbrot set or the set of unbroken cryptographic keys.
