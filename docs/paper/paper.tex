...
library reifies the carrier side as two opt-in trait variables in
\texttt{algebra:quotient} — \lstinline|IsQuotientAlgebra<Q>| and
\lstinline|IsProductAlgebra<Q>| — and a single declaration at each
carrier site fires the structural-trait propagation (associativity,
commutativity, distributivity, totality / saturation) from the
...
as opt-in trait variables; the structural-trait propagation rule on
