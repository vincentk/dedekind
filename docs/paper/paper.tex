...
The top row names the categorical (topos / Cartesian-closed) universal constructions of $\mathbf{Set}$ (product, coproduct, negation, initial and terminal objects, exponential); the lattice rows realise them as the Boolean (logical) operations, the powerset (set-theoretic) operations, and the reification $\mathbf{Trsk} \subset \mathbf{Cpp}$ discussed here (Section~\ref{sec:ddk_etcs}, Eqn~\ref{eqn:trsk}).
