...
\end{equation}
In code the comprehension is \cppinline{set(S,P)}, the emptiness test is an overload of \cppinline{Ø::operator==}, and $\forall$ is the double negation of $\exists$: \cppinline{exists(S,P)} is \cppinline{!(Ø{} == set(S,P))} and \cppinline{forall} is \cppinline{!exists(S,!P)}.
