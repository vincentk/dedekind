...
\begin{itemize}
    ...
    \item \textbf{C++ Reification:} The exponential $B^A$ is the \emph{internal hom} and is required to satisfy \cppinline{concept IsArrow} $A \to B$ by \cppinline{concept IsCartesianClosed} and \cppinline{concept IsArrowExponential}. The adjunction arrows \cppinline{curry} / \cppinline{uncurry} / \cppinline{eval} are library-provided.
