...
for STLC by Lambek--Scott. The C++$\leftrightarrow$STLC translation is
catalogued in Table~\ref{tab:cpp-stlc-mapping}.
...
C++ type checker can discharge mechanically; full
quantification over types (the Curry--Howard reading of dependent
products) is not available in C++23 and is not claimed here. The
``Realisation'' column points to the section where each row is exhibited.}
