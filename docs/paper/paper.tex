...
\clearpage
\subsection{Reference: The Algebraic Lattice and its Carriers}
...
%%%
\clearpage
\subsubsection{Reverse lookup: the built-in primitives by operator surface}
...
The library carriers built on these primitives appear in the master table above (Table~\ref{tab:lattice-carriers}).
