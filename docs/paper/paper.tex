...
Kleisli Extension & $(T, \eta, \gg=)$ & \texttt{operator>>=} & \texttt{IsKleisliExtension} & \texttt{IsAccociative}\\
Kleisli Extension & $\bind$ & \texttt{operator>>=} & \texttt{IsKleisliExtension} & \texttt{IsAccociative}\\
Kleisli Composition & $\circ\_{K}$ & \texttt{operator>>} & \texttt{IsMonad} & \texttt{IsAccociative}\\
