...
The \emph{Juliet Posture} was then used to bootstrap in turn i) an approximation of $\mathbf{Set}$ (sets in the ETCS sense), ii) $\mathbf{Alg}(-)_{\beth_1}$ (sets with algebraic operations), iii) algebraic structures such as magmas, rings, fields, semimodules and modules and so on.
