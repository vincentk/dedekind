...
substrate. Modern AI assistants compress the time and expertise
required to author opt-in trait specialisations, axiom-shape
concepts, and the surrounding library scaffolding by an order of
magnitude, turning what was previously an academic specialism into
an actionable workflow for working software engineers. This paper
argues, by exhibit rather than by theorem, that the cost-benefit
turn matters in practice today.
