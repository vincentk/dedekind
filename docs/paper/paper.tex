...
Supplying that knowledge once, and letting the compiler enforce it thereafter, is what turns these familiar rules into build-time checks and optimizations; Appendix~\ref{sec:trait-registry} records which laws the type system can and cannot certify, and Appendix~\ref{sec:carrier-rosetta} catalogues them across the lattice of carriers.
...
The same carriers, organised by algebraic structure, are catalogued in the master table of the algebraic-lattice appendix (Table~\ref{tab:lattice-carriers}).
...
%%%
\clearpage
\section{The Algebraic Lattice and its Carriers}
\label{sec:carrier-rosetta}

This reference is indexed by algebraic structure (the branching poset of §\ref{sec:algebraic_lattice_carriers}), not by carrier.
