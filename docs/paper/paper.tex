...
Whether an arbitrary carrier obeys a given algebraic law, or an arbitrary program computes a given function, is a non-trivial semantic property, and so undecidable in general (Rice's theorem).
