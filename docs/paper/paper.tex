...
FIXME: https://github.com/vincentk/dedekind/issues/461
The trait-registry mechanics live in §\ref{sec:pruning} and(\emph{Algebraic Lattice})  \ref{sec:numeric-tension} , where the page budget for the compare-and-contrast actually fits.
That section covers which axioms propagate under which constructors, how per-carrier specialisations are organised, how the \emph{Honest Rejection} policy maps to varieties, and how the algebra-side machinery composes with the C++-side concept layer.
...
Listings~\ref{lst:showcase03_src} and \ref{lst:showcase03_ir}
