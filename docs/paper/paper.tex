...
\begin{listing}[ht]
\caption{Honest Rejection in code: $\mathbf{Ddk}$ ships the Galois field $\mathbb{F}_2$ and the exact-arithmetic field $\mathbb{Q}$ safe by default; \cppinline{int} is refused at the gate.  All four static\_asserts compile in $\mathbf{Ddk}$ today.}
