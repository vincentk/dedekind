...
$\mathbb{N}$ bounded & \lstinline|ExtensionalCardinal<N>| & \lstinline|IsCyclicGroup|$^{\dagger}$, \lstinline|IsAbelianGroup<T,+>| \\
...
\lstinline|unsigned long|, \lstinline|size_t| & Modular, wraps at $2^{N}$ & \lstinline|IsCyclicGroup|$^{\dagger}$, \lstinline|IsAbelianGroup<T,+>| \\
