...
\& \mathbb{B} \arrow[rr, dotted, thick, bend right=18, "\mathfrak{i}"']
\&
\& \mathbb{N} \arrow[ll, dotted, thick, bend right=18, "x\,\%\,2=0"] \arrow[rr, dotted, thick, bend right=18, "-x"']
\&
\& \mathbb{Z} \arrow[ll, dotted, thick, bend right=18, "x^2"]
\end{tikzcd}
\caption{
