...
$\mathbf{Ddk}$ ships with two carriers certified safe by default and refuses everything else at the gate.
The first is $\mathbb{B}$ as the Galois field $\mathbb{F}_2$ (Boolean negation, conjunction, exclusive-or). It has finite cardinality, no rounding, no overflow.
The laws hold trivially.
The second is $\mathbb{Q}$ as \cppinline{Rational<I>} for any wide-enough integer carrier $I$.
