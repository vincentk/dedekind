...
In much the same way that category theory can be intimidating, C++ as a whole is a famously inhospitable substrate for formal reasoning.
...
We chose elements from C++ guided by two criteria.
...
C++23 concepts realise the third school.
