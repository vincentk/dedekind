...
\begin{tikzpicture}[every node/.style={font=\small}]
  \foreach \C/\Cube/\Type/\Fid in {%
      ...
      8.1/{$\mathbb{Z}$ (bdd.)}/int/{partial${}^{\dagger}$},
  ...
  \node[font=\scriptsize\itshape] at (6.45,-1.3) {machine primitives $=$ exact shadows of modular Forms; ideals are their period-$\infty$ limits};
\end{tikzpicture}}
\\[0.3ex]{\footnotesize (a) the shadow plot: four primitives as exact shadows}\\[1.6ex]
