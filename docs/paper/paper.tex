...
Where the objective is not monotone, or the domain not so structured, the filter still types but decides only where §\ref{sec:ddk_comprehension}'s certificates reach.
