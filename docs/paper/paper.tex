...
contribution of this paper is an articulation of that discipline,
together with a worked library that discharges its claims mechanically.
...
Table~\ref{tab:cpp-stlc-mapping}, and is the lens through which the
remainder of the paper should be read: subsequent sections cite STLC
and category-theoretic vocabulary directly, rather than re-explaining
