...
The project-specific mnemonic $\mathbf{Sngl}$ is meant to make this engineering generalisation visible at the symbol layer, rather than overload $\mathbf{Mon}$ with a meaning it does not carry in the standard textbook reading.
