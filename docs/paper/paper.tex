...
Two rules carry it: a concept composes a certificate with a property of its parameter (a module over a field \emph{is} a vector space), and a one-line registration forwards the species traits through a construction to the derived carrier (Listing~\ref{lst:hsp-combinators}).
