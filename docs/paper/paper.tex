...
An more industrialized approach involving the automated generation and evaluation of concrete metrics in this style are work in progress and not part of the present paper's claims; what we document here is the architecture under which they would be measured.
...
lineage; checked at compile time but blind to behavior), duck
