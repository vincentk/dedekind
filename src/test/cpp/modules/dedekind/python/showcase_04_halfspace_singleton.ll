...
@llvm.global_ctors = appending global [1 x { i32, ptr, ptr }] [{ i32, ptr, ptr } { i32 65535, ptr @_GLOBAL__sub_I_showcase_04_halfspace_singleton.cpp, ptr null }]
...
define internal void @_GLOBAL__sub_I_showcase_04_halfspace_singleton.cpp() #1 section "__TEXT,__StaticInit,regular,pure_instructions" {
