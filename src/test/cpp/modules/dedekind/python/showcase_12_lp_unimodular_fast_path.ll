...
@llvm.global_ctors = appending global [1 x { i32, ptr, ptr }] [{ i32, ptr, ptr } { i32 65535, ptr @_GLOBAL__sub_I_showcase_12_lp_unimodular_fast_path.cpp, ptr null }]

; Function Attrs: mustprogress nofree noinline norecurse nosync nounwind ssp willreturn memory(none) uwtable
define noundef i64 @witness_lp_fast_optimum_x() local_unnamed_addr #0 {
  ret i64 1
}

; Function Attrs: mustprogress nofree noinline norecurse nosync nounwind ssp willreturn memory(none) uwtable
define noundef i64 @witness_lp_fast_optimum_y() local_unnamed_addr #0 {
  ret i64 1
}
...
define internal void @_GLOBAL__sub_I_showcase_12_lp_unimodular_fast_path.cpp() #1 section "__TEXT,__StaticInit,regular,pure_instructions" {
