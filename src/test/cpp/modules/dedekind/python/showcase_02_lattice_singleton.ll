...
@llvm.global_ctors = appending global [1 x { i32, ptr, ptr }] [{ i32, ptr, ptr } { i32 65535, ptr @_GLOBAL__sub_I_showcase_02_lattice_singleton.cpp, ptr null }]

; Function Attrs: mustprogress nofree noinline norecurse nosync nounwind ssp willreturn memory(none) uwtable
define noundef zeroext i1 @impress_lattice_square_singleton() local_unnamed_addr #0 {
  ret i1 true
}
...
define internal void @_GLOBAL__sub_I_showcase_02_lattice_singleton.cpp() #1 section "__TEXT,__StaticInit,regular,pure_instructions" {
