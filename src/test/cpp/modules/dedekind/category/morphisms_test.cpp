...
TEST_CASE("Category: Algebraic Proofs (Runtime Witnesses)", "[category][morphisms][algebra]") {
    ...
    SECTION("Abelian Property Verification") {
        ...
        // STATIC_CHECK(!IsAbelian<std::string, std::plus<std::string>>);
    }

    SECTION("Small Category Identity Proof") {
        // Verify that the identity_trait is correctly resolved for primitive species.
