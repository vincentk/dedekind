...
static_assert(dedekind::category::IsCommutativeRing<PolyUInt, std::plus<PolyUInt>, std::multiplies<PolyUInt>>,
...
static_assert(
    dedekind::category::IsCommutativeRing<PolyEC, std::plus<PolyEC>, std::multiplies<PolyEC>>,
