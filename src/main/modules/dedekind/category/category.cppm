...
export import :lattice_term;  // Generic lattice-law term reducer (compile-time
                              // normal form over <L,∧,∨,⊤,⊥,¬>; #865/#888/#890)
...
export import :factorisation;  // (Regular epi, mono) factorisation system,
                               // IsRegularCategory / IsExactCategory; row 4–8
                               // of the quotient Form-chain (#718).
...
export import :concrete;  // Concreteness layer (IsSubobject, IsConcrete,
