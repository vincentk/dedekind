...
- Priority by PR state:
  - Draft PR: prioritize closing acceptance-criteria gaps (assess coverage, implement highest-impact missing criteria, add/adjust tests, push a small checkpoint).
  - Near-Ready/Ready PR: prioritize polishing (documentation/report alignment, clarity, low-risk quality refinements, and review-thread closure).
