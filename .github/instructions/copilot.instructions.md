...
- PR workload protocol:
  ...
  - `Ready / Review` protocol: once the PR is ready or under review, prioritize reviewer response and merge readiness. Address review commentary to the best of your abilities, resolve review threads explicitly, preserve CI green status, and focus work on achieving a clean path to merge.
